...
def create_masks(inputs, target):
    ...
    *This function should only use tensorflow operations in order to properly
    ...
    Returns: encoder_mask, look_ahead_mask, decoder_mask
        ...
        @look_ahead_mask: tf.Tensor look ahead mask of shape (batch_size, 1,
        seq_len_out, seq_len_out) to be applied in the decoder
        @decoder_mask: tf.Tensor padding mask of shape (batch_size, 1, 1,
        seq_len_in) to be applied in the decoder
    """
